...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/myWiki/flexsearch.min.js');loadScript('/myWiki/en.search-data.min.3ca47850a5db4fbf63e2eaaa49cc6606591a513173e3194361fe85a5a00a29c5.js',function(){input.required=false;search();});}
