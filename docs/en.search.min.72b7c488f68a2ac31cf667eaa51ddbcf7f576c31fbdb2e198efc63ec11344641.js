...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/myWiki/flexsearch.min.js');loadScript('/myWiki/en.search-data.min.3d97664d9091872d52dd9efd09a4dcc52f60ad6662dded6d1747d10af697b24e.js',function(){input.required=false;search();});}
