...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/myWiki/flexsearch.min.js');loadScript('/myWiki/en.search-data.min.76c3c8bd12dbdf4628c0550abf3d9b71bdd5661fac9866cf76bdf9045ac123db.js',function(){input.required=false;search();});}
