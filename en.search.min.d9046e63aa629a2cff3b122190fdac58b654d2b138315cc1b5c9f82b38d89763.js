...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/myWiki/flexsearch.min.js');loadScript('/myWiki/en.search-data.min.fb93bd4eb59d095fdd880cd28ffa87ee467cdb15e54a558f14b389996bbd9293.js',function(){input.required=false;search();});}
