...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/myWiki/flexsearch.min.js');loadScript('/myWiki/en.search-data.min.52fe7d6251d9acb5d70c0196cc920154a6fe3f85d1a50cf8a7753ad9186acec0.js',function(){input.required=false;search();});}
