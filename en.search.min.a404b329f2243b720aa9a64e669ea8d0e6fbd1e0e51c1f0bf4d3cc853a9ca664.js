...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/myWiki/flexsearch.min.js');loadScript('/myWiki/en.search-data.min.07c831291ac0612dd11f94df07baf5e9dc5301bb9bb3da761bf77935555a0a3a.js',function(){input.required=false;search();});}
